...
*   [hylarucoder/seedance-screenwriter-skills](https://github.com/hylarucoder/seedance-screenwriter-skills) -
...
*   [rp-libs/awesome-rust-python](https://github.com/rp-libs/awesome-rust-python) - A curated list of awesome Python libraries and tools powered by Rust
...
*   [kanadeblisst00/pywxrobot2.0](https://github.com/kanadeblisst00/pywxrobot2.0) - 使用hook实现微信机器人，可用于公众号更新和历史采集，自动同意好友请求，自动邀请进群等
...
*   [MichaelC001/Consolas-Nerd-LXGW-Wenkai-Mono](https://github.com/MichaelC001/Consolas-Nerd-LXGW-Wenkai-Mono) -
...
*   [mzzsfy/Actions-buildUtils](https://github.com/mzzsfy/Actions-buildUtils) - 一些通用的白嫖github Actions的构建工具
...
*   [wukongdaily/allinonescript](https://github.com/wukongdaily/allinonescript) - 在软路由iStoreOS命令行中一键安装多个插件

*   [JushBJJ/Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor) - A GPT-4 AI Tutor Prompt for customizable personalized learning experiences.

*   [yonggekkk/Tuic-yg](https://github.com/yonggekkk/Tuic-yg) - tuic-yg一键脚本，支持V4+V5双版本任意安装，V5多用户无限生成，显示v2rayN、ClashMeta配置明文
...
*   [tian197/project](https://github.com/tian197/project) -
...
*   [gfw-report/shadowsocks-rust](https://github.com/gfw-report/shadowsocks-rust) - 我们有证据表明这个修改版的Shadowsocks-rust可以绕过当前GFW对Shadowsocks的检测和封锁。(https://gfw.report/publications/usenixsecurity23/zh/#sec:popcount) | We have evidences that this modified Shadowsocks-rust can bypass the detection and blocking by the GFW. (https://gfw.report/publications/usenixsecurity23/en/#sec:popcount)
...
*   [adyliu/china\_area](https://github.com/adyliu/china_area) - 2024年中国全国5级行政区划（省、市、县、镇、村）
...
*   [junhongzhang/Excel-Python-DA](https://github.com/junhongzhang/Excel-Python-DA) - 对比Excel，轻松学习Python数据分析
...
*   [trananhkma/fucking-awesome-python](https://github.com/trananhkma/fucking-awesome-python) - awesome-python with :octocat: :star: and :fork\_and\_knife:
...
*   [kingname/stealth.min.js](https://github.com/kingname/stealth.min.js) - 提取出来的 stealth.js
...
*   [zhouaini528/course](https://github.com/zhouaini528/course) - 小白如何在几个小时内学会量化交易
...
*   [budaLi/-Learning-materials-](https://github.com/budaLi/-Learning-materials-) - 各种学习资料，包括一些百度云视频链接还有pdf资料 --搬运工
...
*   [michaelliao/awesome-python3-webapp](https://github.com/michaelliao/awesome-python3-webapp) - 小白的Python入门教程实战篇
...
*   [wukongdaily/gl-inet-onescript](https://github.com/wukongdaily/gl-inet-onescript) - 该项目可以让GL-iNet路由器在不刷机情况下,一键变成iStoreOS风格。

*   [oldfriendme/xrayREALITY](https://github.com/oldfriendme/xrayREALITY) - xray REALITY 一键脚本，支持sni-filter模式。
...
*   [ffuqiangg/build\_openwrt](https://github.com/ffuqiangg/build_openwrt) - 编译 Phicomm N1 使用的 OpenWrt、ImmortalWrt、LEDE、iStoreOS 固件
...
*   [kevin197011/krun](https://github.com/kevin197011/krun) - krun
...
*   [NPCDW/google-sheets-crud](https://github.com/NPCDW/google-sheets-crud) - google sheets 操作，现用于更新 vps 和机场列表
...
*   [wkccd/quickfile](https://github.com/wkccd/quickfile) - Lightweight web-based file manager for OpenWrt/LuCI with minimal resource usage.
...
*   [isxlan0/Codex\_AccountSwitch](https://github.com/isxlan0/Codex_AccountSwitch) - Manage and switch multiple AI coding accounts locally without restarting development tools.
...
*   [xstongxue/XS-VLM-OCR](https://github.com/xstongxue/XS-VLM-OCR) - XS-VLM-OCR：大模型时代的OCR工具🚀
...
*   [smileFAace/MCP-ExcelAutoCpp](https://github.com/smileFAace/MCP-ExcelAutoCpp) - A MCP server for automatically create, view and modify Excel related file using LLM
...
*   [grandiloquent/wifi\_file\_server](https://github.com/grandiloquent/wifi_file_server) - 通过Wifi在手机、电脑、平板等智能设备上共享文件，无需USB线
...
*   [rigaya/x264guiEx](https://github.com/rigaya/x264guiEx) - 拡張 x264 出力(GUI) Ex
...
*   [honghaier-game/PythonIDE-PyMe](https://github.com/honghaier-game/PythonIDE-PyMe) - PyMe – A visual development tool for Python developers. Build software and games through an intuitive visual interface, and publish cross-platform with one click. Make your Python projects run anywhere with ease.
...
*   [zhaozhengcoder/Algorithm](https://github.com/zhaozhengcoder/Algorithm) - leetcode/lintcode 上的算法练习
...
*   [xwxbug/AutoThem](https://github.com/xwxbug/AutoThem) - forked from autoit v3 open source version,clone closed source functions to open source.
...
*   [chixi4/Qwen3.5-9B-ToolHub](https://github.com/chixi4/Qwen3.5-9B-ToolHub) - Qwen3.5-9B ToolHub-v1.0.0
...
*   [MieMieeeee/ComfyUI-Mie-Package-Launcher](https://github.com/MieMieeeee/ComfyUI-Mie-Package-Launcher) -

*   [BeiPoer/claude-api-2-cursor](https://github.com/BeiPoer/claude-api-2-cursor) -
...
*   [Tomiya233/grok2api\_new](https://github.com/Tomiya233/grok2api_new) - 将 Grok 网页端转换为 OpenAI 兼容 API 的逆向代理服务，支持多账号轮询、真实多轮对话上下文、跨账号会话续接，附带可视化管理后台
...
*   [Austin-Patrician/eastmoney](https://github.com/Austin-Patrician/eastmoney) - VibeAlpha Terminal 是一个专注于中国 A 股市场的智能金融分析平台，集成了基金分析、股票监控、商品追踪和市场情绪分析等功能。通过 AI 大语言模型自动生成专业的盘前/盘后分析报告，帮助投资者做出更明智的决策。

*   [lcandy2/enable-chrome-ai](https://github.com/lcandy2/enable-chrome-ai) - Enable Gemini in Chrome, AI Powered History search, DevTools Al Innovations in Google Chrome without cleaning data and reinstall.
...
*   [741liufei/DownList](https://github.com/741liufei/DownList) - An application to download unlimited amount of music from Netease playlist.
...
*   [sskyNS/RoastDuck-CFWPack](https://github.com/sskyNS/RoastDuck-CFWPack) - Piracy is not supported
...
*   [akynazh/jvav](https://github.com/akynazh/jvav) - \[NSFW] Useful tools for crawling adult learning resources.

*   [TongWu/JAVDB\_AutoSpider](https://github.com/TongWu/JAVDB_AutoSpider) - Javdb Auto Spider
...
*   [NakanoSanku/minidevice](https://github.com/NakanoSanku/minidevice) - High Performance Tools To Operate Android Device
...
*   [mrsanshui/WeChatPYAPI](https://github.com/mrsanshui/WeChatPYAPI) - 基于微信PC端的Python接口，开发者可通过Python轻松调用。实现微信机器人、群管理等强大的功能！3.9.10.19、4.0、4.x、x64、微信hook、微信接口
...
*   [seleniumbase/SeleniumBase](https://github.com/seleniumbase/SeleniumBase) - 📊 Python's all-in-one framework for web crawling, scraping, testing, and reporting. Supports pytest. CDP Mode provides stealth. Includes many tools.
...
*   [wxlscm/raspberry\_tutorial](https://github.com/wxlscm/raspberry_tutorial) -
...
*   [iswbm/python-guide](https://github.com/iswbm/python-guide) - Python中文指南：从零到一的零基础 Python 教程
...
*   [jethar/coursera-dl](https://github.com/jethar/coursera-dl) - Script for downloading Coursera.org videos and naming them.
...
*   [Qarj/search-image](https://github.com/Qarj/search-image) - Find the location of one image inside another image
...
*   [gkovacs/remove\_miner\_fees](https://github.com/gkovacs/remove_miner_fees) - Removes miner fees on claymore ethereum miner. Donation: ETH 0xb70fc6f9865ce18c20d90ebf067d9951918f8933
...
*   [bengouyy/mxnet\_mtcnn\_face\_detection](https://github.com/bengouyy/mxnet_mtcnn_face_detection) - MTCNN face detection
...
*   [mibgb65-cloud/OmniProxy](https://github.com/mibgb65-cloud/OmniProxy) - 本地 AI API 令牌调度、额度观测与桌面代理网关，支持多账号、多厂商、失败重试、请求历史和系统托盘常驻。 Local AI API token scheduler, quota monitor, and desktop proxy gateway for OpenAI-compatible, Anthropic, DeepSeek, Kimi, and Xiaomi MiMo   workflows.

*   [jiqi136/Ai-Assistant](https://github.com/jiqi136/Ai-Assistant) - \[Open Source] Novel Writing & AI Programming Assistant. 【公开源码】的小说写作与 AI 编程助手。Aggregates top large models from home and abroad聚合国内外顶尖大模型 (DeepSeek/Gemini/Claude/Kimi/ChatGPT, etc.)

*   [123nhh/tempmail](https://github.com/123nhh/tempmail) - 支持多域名、自动 MX 记录校验及 Web 管理面板的自托管临时邮箱服务。
...
*   [amigoer/weclaw-proxy](https://github.com/amigoer/weclaw-proxy) - A High-Performance Access Gateway for WeChat OpenClaw / 一个面向微信 OpenClaw 的高性能接入网关

*   [freeok/pansou](https://github.com/freeok/pansou) - PanSou是一款高性能的网盘资源搜索API服务，支持TG频道和插件搜索。系统设计以性能和可扩展性为核心，支持多频道多插件并发搜索、结果智能排序和网盘类型分类。docker集成前后端，一键启动，开箱即用。 https://so.252035.xyz/
...
*   [julydate/acmeDeliver](https://github.com/julydate/acmeDeliver) - acme.sh 证书分发服务
...
*   [novvoo/gcurl](https://github.com/novvoo/gcurl) -
...
*   [lyc8503/PTHackPoC](https://github.com/lyc8503/PTHackPoC) - PT 免费下载, 刷流量, 以及更多
...
*   [nopdan/rose](https://github.com/nopdan/rose) - 输入法用户词库转换工具 |  Input Method User Dictionary Converter.
...
*   [SIPC/H2O](https://github.com/SIPC/H2O) - Hysteria2 Ops — One-stop management for your Hy2 nodes
...
*   [klsf/codex-register](https://github.com/klsf/codex-register) - 用于批量注册 OpenAI 账号、授权Codex登录生成授权文件，可直接导入cliproxyapi使用，以及批量检查凭证剩余可用额度。

*   [UNLINEARITY/CLI-WeChat-Bridge](https://github.com/UNLINEARITY/CLI-WeChat-Bridge) - 将 AI 命令行工具以最为原生的方式，集成到微信 ClawBot 中，目前支持集成 Codex、Claude Code、OpenCode。 支持微信和本地终端线程（thread/session）共享、双向对话，支持将本地文件传输至微信，微信也支持发送文件到终端。现已支持多cli切换、微信表情绑定指令。
...
*   [clawnetes/Clawnetes](https://github.com/clawnetes/Clawnetes) - The orchestrator for Claws
...
*   [JimmyPowell/cf-rss-analyse](https://github.com/JimmyPowell/cf-rss-analyse) - 基于 Cloudflare Workers + D1 + AI Gateway 的智能 RSS 聚合器，让 AI 帮你从海量信息中发现真正感兴趣的内容。
...
*   [xianyu110/gemini-nanobanana-pro](https://github.com/xianyu110/gemini-nanobanana-pro) - 基于 Google Gemini 2.5 Flash Image Preview 模型打造的精美 AI 图像生成与编辑 Web应用，使用 Next.js 构建
...
*   [aigem/aice\_ps](https://github.com/aigem/aice_ps) - Nano Banana editor(webui) for aistudio or gemini api key.  最强Ai修图APP，方便实用！如登录了google aistudio，可直接在DEMO APP中使用。支持静态部署，兼容Gemini API

*   [xishang0128/sparkle](https://github.com/xishang0128/sparkle) - :electron: Another Mihomo GUI. (🛠building...)

*   [EBOLABOY/xhs-ai-writer](https://github.com/EBOLABOY/xhs-ai-writer) - 这是一个专为小红书内容创作者打造的AI工具，能够智能分析热门笔记并生成高质量的爆款文案。
...
*   [FaiChou/IntraPaste](https://github.com/FaiChou/IntraPaste) - IntraPaste is a simple content sharing service

*   [whale4113/cloud-document-converter](https://github.com/whale4113/cloud-document-converter) - Convert Lark Doc to Markdown

*   [nicekate/Al-StoryLab](https://github.com/nicekate/Al-StoryLab) - AI-StoryLab 是一款基于 Next.js 的智能故事创作平台，集成音频制作与 AI 绘图提示词生成功能。
...
*   [omegaee/my-fingerprint](https://github.com/omegaee/my-fingerprint) - 保护你的浏览器指纹 | Protect Your Browser Fingerprints | Chrome, Edge, Firefox | 扩展 / Extension
...
*   [Rockyzsu/GeminiChat](https://github.com/Rockyzsu/GeminiChat) - google Gemini Web Online
...
*   [chitiabao/discourse2MD](https://github.com/chitiabao/discourse2MD) - Discourse2MD 是一个用于将帖子转为Markdown导出的脚本工具，支持 Discourse 类社区。 欢迎佬友们使用！

*   [TheSmallHanCat/Flow2API-Token-Updater](https://github.com/TheSmallHanCat/Flow2API-Token-Updater) - 与flow2api配套使用
...
*   [XyzenSun/vibespace](https://github.com/XyzenSun/vibespace) - 通过可视化向导，根据你的开发技术栈，选择配置好Skills，MCP，Agent的AI开发工具，一键生成容器化Vibe开发环境。

*   [Xchat1/cursor2api-go](https://github.com/Xchat1/cursor2api-go) - Free gemini-3-flash  | cursor不倒我不倒🙏 ❌ 这次倒下啦

*   [aiguicai/Cursor-Toolbox](https://github.com/aiguicai/Cursor-Toolbox) -
...
*   [dongshuyan/cookie-helper](https://github.com/dongshuyan/cookie-helper) - cookie-helper

*   [XianYuDaXian/grok2api](https://github.com/XianYuDaXian/grok2api) - 个人基于chenyme Grok2API的修改版本，在原版基础上支持nsfw全程工作流，视频工作台循环拼接，夜间模式和移动端UI适配等

*   [Gary-zy/AliasGUI](https://github.com/Gary-zy/AliasGUI) - AliasGUl

*   [nmgliangwei/qqwry.ipdb](https://github.com/nmgliangwei/qqwry.ipdb) - 纯真数据库 IPIP.net 格式版
...
*   [xixu-me/xget-now](https://github.com/xixu-me/xget-now) - Cross-browser extension for Chromium and Firefox that accelerates file downloads
...
*   [HereisFrank9527/Z-Reader](https://github.com/HereisFrank9527/Z-Reader) - 爬取笔趣阁文章
...
*   [faithererer/checker](https://github.com/faithererer/checker) - API Key 批量有效性检测工具
...
*   [immortalwrt/homeproxy](https://github.com/immortalwrt/homeproxy) - The modern ImmortalWrt proxy platform for ARM64/AMD64 (powered by sing-box)
...
*   [7ednet/private-docker-mirror](https://github.com/7ednet/private-docker-mirror) -
...
*   [kylelv2000/oaifree-helper](https://github.com/kylelv2000/oaifree-helper) - 本项目基于始皇的new站服务。利用单个Worker\&Pages优雅访问始皇镜像站，组建合租共享车队。包含直链登陆、前端登陆页、用户管理、token池管理、车队管理、用户注册、用量查询等等功能。全程无需服务器和域名，无需改代码
...
*   [valinet/ExplorerPatcher-L10N](https://github.com/valinet/ExplorerPatcher-L10N) - Localizations for ExplorerPatcher
...
*   [liyuec/easyExcelJs](https://github.com/liyuec/easyExcelJs) - 简单的操作生成漂亮的EXCEL，快速上手。提供漂亮模板直接使用
...
*   [keenwon/antcolony](https://github.com/keenwon/antcolony) - Nodejs实现的一个磁力链接爬虫 https://findit.keenwon.com (原域名http://findit.so )
...
*   [soulteary/docker-wechat-markdown-editor](https://github.com/soulteary/docker-wechat-markdown-editor) - 开箱即食的微信编辑器。（容器镜像大约6M）
...
*   [tces1/Aria2-Helper-for-115](https://github.com/tces1/Aria2-Helper-for-115) - 115\_aria2助手备份, 均为开放代码构成，尝试之前自己先检查一遍安全风险

*   [google/zx](https://github.com/google/zx) - A tool for writing better scripts

*   [apachecn/apachecn-dl-zh](https://github.com/apachecn/apachecn-dl-zh) - ApacheCN 深度学习译文集

*   [adam-golab/react-developer-roadmap](https://github.com/adam-golab/react-developer-roadmap) - Roadmap to becoming a React developer

*   [imba97/Btools](https://github.com/imba97/Btools) - Btools
...
*   [jhawthorn/curl-to-ruby](https://github.com/jhawthorn/curl-to-ruby) - :arrow\_down: Convert a curl command into ruby's net/http
...
*   [margbug01/ManyMail](https://github.com/margbug01/ManyMail) - Self-hosted mail service — SMTP receiver + REST API + Web viewer

*   [HChaoHui/msOauth2api](https://github.com/HChaoHui/msOauth2api) - 将微软Oauth2登录取件转换为API取件 部署在Vercel 无服务器版

*   [xLmiler/grok2api\_python](https://github.com/xLmiler/grok2api_python) -
...
*   [xiaohu31/doubao-voice-helper](https://github.com/xiaohu31/doubao-voice-helper) - 豆包语音输入助手 - Windows 豆包语音输入增强工具

*   [JlonGit/hotkey](https://github.com/JlonGit/hotkey) - 这是一个基于 AutoHotkey v2.0 的 Windows 快捷键增强脚本，提供了丰富的功能来提高您的工作效率。
...
*   [semicons/java\_oci\_manage](https://github.com/semicons/java_oci_manage) - Web SSH Smart Terminal for multi-cloud management (OCI / AWS / GCP / Azure / DO / SolusVM /VirtFusion), with cloud panel, Telegram bot, and Cloudflare integration — 面向多云管理的 Web SSH 智能终端，集成云管理面板、Telegram 机器人与Cloudflare
...
*   [huao1990/KomaVideo](https://github.com/huao1990/KomaVideo) - A sample local video

*   [yaming116/uiautomatorview](https://github.com/yaming116/uiautomatorview) - 给uiautomatorview添加xpath等待

*   [SplashCodes/JAViewer](https://github.com/SplashCodes/JAViewer) - 更优雅的驾车体验

## Batchfile

*   [Amamiyashi0n/MAS-GUI-win](https://github.com/Amamiyashi0n/MAS-GUI-win) - A GUI for MAS

*   [krishnakanthb13/ai\_cli\_manager](https://github.com/krishnakanthb13/ai_cli_manager) - AI CLI Manager is a powerful command-line utility designed to simplify the installation, management, and launching of various AI coding assistants. It bridges the gap between different AI tools, providing a unified interface and seamless Windows integration.
...
*   [Hzzone/MTLFace](https://github.com/Hzzone/MTLFace) - When Age-Invariant Face Recognition Meets Face Age Synthesis: A Multi-Task Learning Framework (CVPR 2021 oral & TPAMI 2022)
...
*   [Zhou-kun/Excel-Python-Learning-Note](https://github.com/Zhou-kun/Excel-Python-Learning-Note) -

*   [google-research/vision\_transformer](https://github.com/google-research/vision_transformer) -
...
*   [tioners/SMSForwarder](https://github.com/tioners/SMSForwarder) -
...
*   [kenzok8/small](https://github.com/kenzok8/small) -  homeprxoy mihomo sing-box 依赖
...
*   [ligl0702/ssipk](https://github.com/ligl0702/ssipk) - test for helloworld
...
*   [HamletDuFromage/switch-cheats-updater](https://github.com/HamletDuFromage/switch-cheats-updater) - A Nintendo Switch homebrew app to automatically update your cheat files for your installed games.
...
*   [xwxbug/diskdir-extended](https://github.com/xwxbug/diskdir-extended) - DiskDir Extended - plugin for Total Commander listing directory structure including archive files(forked version,support utf8)
...
*   [felixbuenemann/xlsxtream](https://github.com/felixbuenemann/xlsxtream) - Streaming & Fast XLSX Spreadsheet Writer for Ruby
...
*   [net-ssh/net-sftp](https://github.com/net-ssh/net-sftp) - Pure Ruby implementation of an SFTP (protocols 1-6) client.

*   [lanrion/qy\_wechat\_api](https://github.com/lanrion/qy_wechat_api) - 企业微信高级API Ruby版本

*   [sparklemotion/sqlite3-ruby](https://github.com/sparklemotion/sqlite3-ruby) - Ruby bindings for the SQLite3 embedded database

*   [vadviktor/file-replicator](https://github.com/vadviktor/file-replicator) - Ruby Gem, providing a command line utility to split and merge files (binary mode)

*   [ansoni/watir-extensions-element-screenshot](https://github.com/ansoni/watir-extensions-element-screenshot) - Element Screenshot Support for watir

*   [awesome-print/awesome\_print](https://github.com/awesome-print/awesome_print) - Pretty print your Ruby objects with style -- in full color and with proper indentation
...
*   [soulteary/docker-pytorch-playground](https://github.com/soulteary/docker-pytorch-playground) - Running models faster and easier, support for x86 and ARM (M1, M1Pro).

*   [iggredible/Learn-Vim](https://github.com/iggredible/Learn-Vim) - Learning Vim and Vimscript doesn't have to be hard. This is the guide that you're looking for 📖

*   [yanlongma/docker-lnmp](https://github.com/yanlongma/docker-lnmp) - Deploying LNMP(Linux、Nginx、Mysql、PHP-FPM) using docker-compose.
...
*   [L-Trump/Scoop-CHS](https://github.com/L-Trump/Scoop-CHS) - Scoop汉化版，它来了
...
*   [soulteary/ngx-php-micro-blog](https://github.com/soulteary/ngx-php-micro-blog) - Microlog example based on Nginx and Nginx module (NGX-PHP8), A high-performance implementation that does not use the combination of Nginx and PHP-FPM, which is safe and reliable.
...
*   [luyishisi/shisi.eth-in-web3](https://github.com/luyishisi/shisi.eth-in-web3) - 十四君公众号文章的相关代码资源开源
